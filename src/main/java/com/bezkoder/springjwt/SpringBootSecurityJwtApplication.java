...
public class SpringBootSecurityJwtApplication {
	...
	@Bean
    CommandLineRunner init(RoleRepository RoleRepository,UserRepository userRepository,ProductRepository productRepository,
    CategoryRepository categoryRepository
        ...
        return args -> {
          ...
          Role r3=new Role(ERole.ROLE_USER);
                ...
                r.add(r2);
                r.add(r3);
				User user = new User("mod",
				"mrissaoussama@gmail.com",
				encoder.encode("123456"),r);
